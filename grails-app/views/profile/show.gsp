	...
	<body>
		...
		<div id="show-profile" class="content scaffold-show" role="main">
			...
			<ol class="property-list profile">
				...
				<g:if test="${profileInstance?.resumePath}">
				<li class="fieldcontain">
					<span id="resumePath-label" class="property-label"><g:message code="profile.resumePath.label" default="Resume Path" /></span>
					
						<span class="property-value" aria-labelledby="resumePath-label"><g:fieldValue bean="${profileInstance}" field="resumePath"/></span>
