...
<div class="jumbotron">
    <div class="container-fluid">
        <h2> <img src="${resource(dir: 'images', file: 'logo.png')}" alt="Grails" /></h2>
        <h6>Join Us and be part of leading organisation.</h6>
    </div>
</div>
<!--login modal-->
...
<script type='text/javascript' src="${resource(dir: 'assets/javascript',file: 'bootstrap.js')}"></script>
